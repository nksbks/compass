...
> Άνοιγμα αυτής της σελίδας στο [https://nksbks.github.io/compass/](https://nksbks.github.io/compass/)
...
* αναζήτηση για **https://github.com/nksbks/compass** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/nksbks/compass/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/nksbks/compass** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/nksbks/compass/raw/master/.github/makecode/blocks.png)
